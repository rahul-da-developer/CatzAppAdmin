...
const JobPostManagement = React.lazy(() => import('./views/JobPostManagement'))
const Jobseekers = React.lazy(() => import('./views/Jobseekers'))
...
const ClientManagement = React.lazy(() => import('./views/ClientManagement'))
...
const routes = [
  ...
  { path: '/client-management', name: 'Buttons', element: ClientManagement, exact: true },
  ...
  { path: '/order-history', name: 'Widgets', element: OrderHistory },
  { path: '/job-post-management', name: 'Job Management', element: JobPostManagement },
  { path: '/Jobseeker', name: 'Jobseekers', element: Jobseekers },
