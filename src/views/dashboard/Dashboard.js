...
const Dashboard = () => {
  ...
  const columns = [
    ...
    {
      name: "Action",
      cell: (row) => <button className='btn btn-sm btn-outline-success rounded-4 px-3'>Approve</button>
  ...
  return (
    <>
      ...
      <CRow>
        <CCol xs>
          <CCard className="mb-4">
            {/* <CCardHeader>Onboarded {' & '} Clients</CCardHeader> */}
            <CCardBody>
              {/* <CRow>
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                <div>
                  <h2 className=' heading p-3'>Onboard Clients</h2>
